  ...
  return (
    <aside className={styles.sidebar}>
      ...
      <nav className={styles.nav}>
        ...
        <Link href="/renovacoes" className={`${styles.navLink} ${pathname.startsWith("/renovacoes") ? styles.active : ""}`} title="Renovações">
          <span className={styles.icon}>🔄</span>
          <span className={styles.label}>Renovações</span>
        </Link>
        ...
        <Link href="/trafego" className={`${styles.navLink} ${pathname.startsWith("/trafego") ? styles.active : ""}`} title="Tráfego">
          <span className={styles.icon}>📣</span>
          <span className={styles.label}>Tráfego</span>
        </Link>
        <Link href="/engajamento" className={`${styles.navLink} ${pathname.startsWith("/engajamento") ? styles.active : ""}`} title="Engajamento">
          <span className={styles.icon}>🔥</span>
          <span className={styles.label}>Treinos</span>
        </Link>
        <Link href="/instagram" className={`${styles.navLink} ${pathname.startsWith("/instagram") ? styles.active : ""}`} title="Instagram (retrato, com data)">
          <span className={styles.icon}>📸</span>
